import { CreateRatingDto, GetRatingsByUserIdDto, RatingSchema, RatingsByReleaseSchema, RatingTypeSchema } from "../../../modules/rating/rating.schema";
...
registry.register("RatingsByRelease", RatingsByReleaseSchema);
...
registry.registerPath({
    method: "get",
    path: "/rating/release/{id}/me",
    tags: ["Rating"],
    summary: "Buscar avaliação do usuario por release",
...
registry.registerPath({
    ...
    tags: ["Rating"],
    summary: "Buscar avaliações por release",
    description: "Retorna as avaliações de uma release",
    request: {
        params: z.object({
            id: z.string().openapi({ description: "ID do release (álbum ou faixa)", example: "4aawyAB9vmqN3uQ7FjRGTy" })
        })
